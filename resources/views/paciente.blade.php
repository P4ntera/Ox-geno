                    ...
                    <tbody id="tablaPacientes">
                        @forelse($pacientes as $paciente)
                            <tr>
                                ...
                                <td>{{ $paciente->ars->nombre ?? 'No asegurado'}}</td>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control" id="cedula" name="cedula_paciente"
                                    maxlength="13" pattern="\d{3}-\d{7}-\d" required>
                            </div>
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="number" step="1" class="form-control" id="edad"
                                    name="edad_paciente" min="1" required>
                            </div>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            editar.forEach(btn => {
                btn.addEventListener("click", function() {
                    ...
                    document.getElementById('id_ars').value = this.dataset.seguro;
